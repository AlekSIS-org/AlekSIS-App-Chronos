# Generated by Django 2.2.3 on 2019-07-16 11:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('periods', models.ManyToManyField(related_name='lessons', to='chronos.TimePeriod')),
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lessons', to='chronos.Subject')),
                ('teachers', models.ManyToManyField(related_name='lessons', to='core.Person')),
            ],
        ),
    ]
